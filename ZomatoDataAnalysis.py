...
import pandas as pd
df = pd.read_csv('C:/Users/Abhishek/Desktop/Learn/zomato.csv', encoding = 'latin-1',  sep=',')
df.head()
...
dfCleanIndia.to_csv('C:/Users/Abhishek/Desktop/Learn/ZomatoIndiaCleaned.csv')
