...
import pandas as pd
df = pd.read_csv('C:/Users/Abhishek/Desktop/Learn/ZomatoIndiaCleaned.csv', encoding = 'latin-1', sep = ',')
df.head()
...
# 4. Of all the 5 Models, the best accuracy that we are getting is for the decision tree classifier with the accuracy of  around 69%. This means that the Decision Tree model is predicting nearly 70% of the test data accurately
